...
@Component({
  selector: 'app-nine-segment-display',
  standalone: true,
  imports: [],
  templateUrl: './nine-segment-display.component.html',
  styleUrl: './nine-segment-display.component.scss'
})
export class NineSegmentDisplayComponent {

  private _bitMask: number = 0b000000000
  ...
  drawSevenSegments () {
    if (this.canvas && this.canvas.nativeElement) {
      ...
      let coordSegments = [
        ...
        { x : 43, y : 28, l : 14, w : 10, v : false }, // D1
        { x : 43, y : 72, l : 14, w : 10, v : false }, // D2
      ]
